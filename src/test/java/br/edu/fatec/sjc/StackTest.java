...
import com.mock.CalculableStrategy;
import com.mock.CustomStack;
import com.mock.StackEmptyException;
import com.mock.StackFullException;
...
public class StackTest {
    ...
    public void validatePushOneElementInStack() {
        ...
        Double value = 0.0;
        Mockito.when(
                calculableStrategy.calculateValue(Mockito.anyDouble())).thenReturn(5.0);
        try {
    ...
    public void validatePushTwoElementAndRemoveOneOfThenInStack() {
        ...
        Double value = 0.0;
        Mockito.when(
                calculableStrategy.calculateValue(Mockito.anyDouble())).thenReturn(10.0);
        try {
            stack.push(5.0);
    ...
    public void validatePushTwoElementForStackWithLimitSizeEqualOne() {
        ...
        Mockito.when(
                calculableStrategy.calculateValue(Mockito.anyDouble())).thenReturn(20.0);
        try {
            stack.push(5.0);
